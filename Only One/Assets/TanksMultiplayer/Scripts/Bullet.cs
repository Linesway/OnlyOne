    ...
    public class Bullet : Photon.MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider col)
        {
            ...
            if (player != null)
            {
                ...
                if (hitClip[Random.Range(0, 2)]) AudioManager.Play3D(hitClip[Random.Range(0, 2)], transform.position);
            ...
            else if (bounce > 0)
            {
                ...
                if (Physics.SphereCast(ray, sphereCol.radius, out hit, speed, 1 << 0))
                {
                    ...
                    if (hitClip[Random.Range(0, 3)]) AudioManager.Play3D(hitClip[Random.Range(0, 3)], transform.position);
